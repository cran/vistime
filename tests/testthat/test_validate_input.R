...
test_that("Deprecated warnings", {
  ...
  expect_warning(
    validate_input(dat, start, end, events, groups,  tooltips, optimize_y,  linewidth, title,
                             showLabels = F, show_labels, lineInterval = 3 * 60 * 60, background_lines),
...
test_that("data formats", {
  ...
  expect_error(
    validate_input(dat, start, end, events, groups,  tooltips, optimize_y, linewidth, title,
                             showLabels, show_labels = "TRUE", lineInterval, background_lines),
    "show_labels is not of class 'logical'"
  )
  ...
  expect_warning(
    validate_input(dat, start, end, events, groups,  tooltips, optimize_y, linewidth, title,
                             showLabels, show_labels, lineInterval, background_lines = 11.5),
  ...
  expect_error(
    validate_input(data.frame(mystart = "20180101"), start = "mystart",
                             end, events, groups,  tooltips, optimize_y, linewidth, title, showLabels, show_labels, lineInterval, background_lines),
